  ...
  <div class="min-h-screen relative">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative">
      ...
      <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white font-serif">工具箱</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400">一站式管理您的工作任务与生活计划，让每一天都井井有条</p>
      </div>
            ...
            <div v-if="selectedTool === 'mock'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center">
                  <MockIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">MOCK工具</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">快速生成模拟数据</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'docs'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center">
                  <DocsIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">文档管理</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">项目文档集中管理</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'json'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-green-500 to-emerald-500 flex items-center justify-center">
                  <JsonIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">JSON/XML工具</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">格式化和转换工具</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'git'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                  <GitIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">GIT辅助工具</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">Git命令生成器</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'md5'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center">
                  <Md5Icon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">MD5工具</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">MD5加密和解密</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'diff'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center">
                  <DiffIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">文本比较</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">文本差异对比工具</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'api'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-cyan-500 to-blue-500 flex items-center justify-center">
                  <ApiIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">接口文档</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">API文档生成器</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'favorites'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-yellow-500 to-orange-500 flex items-center justify-center">
                  <FavoritesIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">收藏列表</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">常用工具收藏</p>
                </div>
              </div>
            ...
            <div v-if="selectedTool === 'new'" class="space-y-4">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-gray-500 to-gray-600 flex items-center justify-center">
                  <NewIcon class="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 class="text-lg font-semibold text-gray-900 dark:text-white">新建工具</h3>
                  <p class="text-sm text-gray-500 dark:text-gray-400">创建自定义工具</p>
                </div>
              </div>
